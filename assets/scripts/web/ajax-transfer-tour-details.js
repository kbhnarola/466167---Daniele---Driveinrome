...
}, 'You can not fill more than 8 people for the transfer tour.');
...
jQuery("#tourAvailabilityForm").validate({
    ...
    groups: {
        adults: "adults kids senior_person"
    },
        ...
        jQuery.ajax({
            ...
            success: function (r) {
                ...
                if (r.success) {
                    ...
                    if (atob(jQuery("#tour_type_id").val()) == 9) {
                        if (total_person <= 3) {
                    ...
                    } else if (atob(jQuery("#tour_type_id").val()) == 10) {
                    ...
                    var final_total_price = get_total_price_b;
                        ...
                        if (jQuery.inArray(item.tour_date, date_array) != -1) {
                            ...
                            if (item.price_type == 2) {
                                if (item.tour_availability == 0) {
                                    ...
                                    if (atob(jQuery("#tour_type_id").val()) == 10) {

                                        if (adults > 0 && item.variation_id == 25) {
                                            adult_price_v = item.price * adults;
                                        }
                                        if (senior_person > 0 && item.variation_id == 26) {
                                            senior_price_v = item.price * senior_person;
                                        }
                                        if (kids > 0 && item.variation_id == 27) {
...
jQuery(document).ready(function () {
    ...
    jQuery("#adults, #kids, #senior_person").select2({ minimumResultsForSearch: -1 });
    // ajxLoader('show', 'body');
});
