...
<div class="page-header page-header-default">
  <div class="page-header-content">
    <div class="page-title">
      <h4>
        <span class="text-semibold"><?php echo _l('add_shared_tour'); ?></span>
      </h4>
    </div>
  </div>
      ...
      <div class="panel panel-flat">
        ...
        <div class="panel-body">
          <div class="custom-form">
            <form action="<?php echo admin_url('shared_tour/add'); ?>" id="addSharedTour" method="POST">
              <fieldset>
                <legend><?php echo _l('add_shared_tour'); ?></legend>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      <div class="tour-wrapper">
                        <input type="radio" name="tour" id="civitavecchia" class="checkbox-input" checked value="1">
                        <label for="civitavecchia" class="checkbox-label">
                          <div class="checkbox-text">
                            <p class="checkbox-text--title">Civitavecchia</p>
                          </div>
                        </label>
                        <input type="radio" name="tour" id="livorno" class="checkbox-input" value="2" />
                        <label for="livorno" class="checkbox-label">
                          <div class="checkbox-text">
                            <p class="checkbox-text--title">Livorno</p>
                          </div>
                        </label>
                        <input type="radio" name="tour" id="naples" class="checkbox-input" value="3" />
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="input-group date tour_datepicker">
                        <input type="text" name="tour_date" id="tour_date" class="form-control tour_date" placeholder="Select Date" autocomplete="off" aria-invalid="false">
                  ...
                  <div class="row">
                    <div class="col-md-6 tour-id-selction">
                      ...
                      <select name="tour_variable_id" id="tour_variable_id" class="form-control" autocomplete="off">
                        ...
                        ?>
                            <option value="<?php echo $single_shared_tour_variable['id'] ?>"><?php echo $single_shared_tour_variable['name']; ?></option>
                        <?php
                          }
                        }
                        ?>
                    ...
                    <div class="col-md-6">
                      ...
                      <input type="number" id="passengers" class="form-control" name="passengers" autocomplete="off">
                    </div>
                  </div>
                </div>
                <div class="form-group">
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      <input type="text" id="agency" class="form-control" name="agency" autocomplete="off">
                    </div>
                    <div class="col-md-6">
                      <label class="col-form-label label_text text-lg-right "><?php echo _l('ship'); ?><small class="req text-danger">*</small></label>
                      <input type="text" id="ship" class="form-control" name="ship" autocomplete="off">
                    </div>
                  </div>
                </div>
                <div class="form-group">
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      <input type="text" id="time" class="form-control" name="time" autocomplete="off">
                    </div>
                  </div>
                </div>
                <div class="form-group">
                  <div class="row">
                    <div class="col-md-12">
                      ...
                      <textarea id="notes" name="notes" class="form-control resize_box" rows="4"></textarea>
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="btn-bottom-toolbar text-center btn-toolbar-container-out">
                    <button type="submit" class="btn btn-primary" name="add_shared_tour"><?php echo _l('add_shared_tour'); ?></button>
