        ...
        <div class="panel panel-flat">
          ...
          <div class="panel-body">
            <div class="custom-form">
              <form action="<?php echo admin_url('cms_pages/add'); ?>" id="addCMSform" method="POST">
                ...
                <fieldset>
                  ...
                  <div class="form-group">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <input type="text" id="cms_page_title" class="form-control" name="cms_page_title" autocomplete="off" placeholder="<?php _el('title');?>">
                        </div>
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="row">
                    <div class="btn-bottom-toolbar text-center btn-toolbar-container-out">
                      <input type="hidden" name="cms_page_id" id="cms_page_id" value="">
                      <button type="submit" class="btn btn-primary" name="add_cms_page"><?php _el('add_cms_page'); ?></button>
                      <button type="reset" class="btn btn-default" name="reset_cms_page_form" id="reset_cms_page_form"><?php _el('reset'); ?></button>
                    </div>
                  </div>
                </fieldset>
              </form>
