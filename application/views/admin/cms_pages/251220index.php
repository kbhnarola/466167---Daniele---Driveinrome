...
<div class="content">
    ...
    <div class="panel panel-flat">
        ...
        <div class="panel-heading">
            <a href="<?php echo base_url('admin/cms_pages/add'); ?>" class="btn btn-primary"><?php _el('add_new'); ?><i class="icon-plus-circle2 position-right"></i></a>
        </div>
        <!-- /Panel heading -->
        <div class="row">
            <div class="col-sm-12">
        ...
        <div class="panel-body table-responsive">
            <table id="cms_pages_list_table" class="table table-bordered table-striped" >
                <thead>
                    <tr>
                        <th>#</th>
                        <th>Page Title</th>
