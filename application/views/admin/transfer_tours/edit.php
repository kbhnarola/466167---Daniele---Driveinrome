  ...
  <div class="breadcrumb-line">
    ...
    <ul class="breadcrumb">
      ...
      <li>
        ...
        <a href="<?php echo admin_url('tours'); ?>"><i class="icon-home2 position-left"></i><?php _el('manage_transfer_tour'); ?></a>

      </li>

      <!-- <li>

        <a href="<?php //echo admin_url('tours'); 

                  ?>"><?php //_el('transfer_tours'); 
...
<div class="content ">
  ...
  <form class="form-horizontal msf" id="editTourform" method="post" enctype="multipart/form-data" action="<?php echo admin_url('transfer_tours/edit/' . base64_encode($toursData['id'])); ?>">
    ...
    <div class="msf-header">
      ...
      <div class="row text-center">
        ...
        <div class="msf-step col-md-3" data-id="1"><i class="fa fa-info"></i> <span><?php echo _l('enter_transfer_tour_details'); ?></span></div>

        <div class="msf-step col-md-3" data-id="2"><i class="fa fa-file-text" aria-hidden="true"></i><span><?php echo _l('transfer_tour_description'); ?></span></div>

        <div class="msf-step col-md-3" data-id="3"><i class="fa fa-image"></i> <span><?php echo _l('transfer_tour_images'); ?></span></div>

        <div class="msf-step col-md-3" data-id="4"><i class="fa fa-money" aria-hidden="true"></i> <span><?php echo _l('transfer_tour_price'); ?></span></div>
      ...
      <div class="msf-view">
        ...
        <div class="form-group">
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <label class="col-form-label label_text text-lg-right "><?php _el('transfer_tour_name'); ?><small class="req text-danger">*</small></label>

              <input type="text" id="tour_name" class="form-control" name="tour_name" autocomplete="off" placeholder="<?php _el('transfer_tour_name'); ?>" value="<?php echo $toursData['title']; ?>">

            </div>

            <div class="col-md-6">

              <label class="col-form-label label_text text-lg-right"><?php _el('transfer_tour_unique_code'); ?><small class="req text-danger">*</small></label>

              <input type="text" id="tour_unique_code" class="form-control" name="tour_unique_code" autocomplete="off" placeholder="<?php _el('transfer_tour_unique_code'); ?>" value="<?php echo $toursData['unique_code']; ?>">
        ...
        <div class="form-group">
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <label class="col-form-label label_text text-lg-right "><?php echo _l('select_', _l('transfer_tour_type')); ?><small class="req text-danger">*</small></label>

              <select id="tour_type" name="tour_type" class="form-control">

                <option value=""><?php echo _l('select_', _l('transfer_tour_type')); ?></option>
            ...
            <div class="col-md-6">
              ...
              <label class="col-form-label label_text text-lg-right"><?php _el('transfer_tour_category'); ?><small class="req text-danger">*</small></label>

              <select id="tour_category" name="tour_category" class="form-control" placeholder="<?php _el('transfer_tour_category'); ?>">
        ...
        <div class="form-group">
          ...
          <div class="row">
            ...
            <div class="col-md-6 is-city-tour-wrap <?php echo ($toursData['tour_type_id'] == 7) ? '' : 'hide' ?>">

              <label class="col-form-label label_text text-lg-right ">Is City tour?</label>

              <div class="w-100">

                <div class="radio-inline chk_topsell">

                  <input type="radio" name="is_city_tour" <?php echo ($toursData['is_city_tour'] == 1) ? 'checked=""' : '' ?> value="1">Yes

                </div>

                <div class="radio-inline chk_topsell">

                  <input type="radio" name="is_city_tour" <?php echo ($toursData['is_city_tour'] == 0) ? 'checked=""' : '' ?> value="0">No
            ...
            <div class="col-md-6">
              ...
              <label class="col-form-label label_text text-lg-right "><?php echo _l('duration'); ?><span class="duration_lbl"> <?php if ($toursData['tour_type_id'] == 8) { ?>(In Days)<?php } else { ?>(In Hours)<?php } ?></span><small class="req text-danger">*</small></label>
            ...
            <div class="col-md-6">
              ...
              <label class="col-form-label label_text text-lg-right ">Youtube video URL<span class="duration_lbl"> (Leave it empty if you don't want)</span></label>

              <input type="text" id="video_url" class="form-control" name="video_url" autocomplete="off" placeholder="Enter youtube video URL" value="<?php echo $toursData['video_url']; ?>">
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              ?>
                ...
                <label class="col-form-label label_text text-lg-right">Select active campaign automation (Default: Free guide)</label>

                <select id="active_campaign_automation" name="active_campaign_automation" class="form-control">

                  <?php

                  $active_campaign_id = DEFAULT_ACTIVE_CAMPAIGN_ID;

                  if ($toursData['active_campaign_automation_id']) {

                    $active_campaign_id = $toursData['active_campaign_automation_id'];
                  ...
                  ?>
                      ...
                      <option value="<?php echo $automation->id ?>" <?php echo ($active_campaign_id == $automation->id) ? 'selected="selected"' : '' ?>><?php echo $automation->name; ?></option>
              ...
              <div class="panel-heading" role="tab" id="headingOne">
                ...
                <h4 class="panel-title">
                  ...
                  <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                    ...
                    <?php echo _l('transfer_tour_description'); ?>
              ...
              <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                ...
                <div class="panel-body">
                  ...
                  <div class="form-group">
                    ...
                    <label class="col-form-label label_text text-lg-right "><?php _el('transfer_tour_description'); ?><small class="req text-danger">*</small></label>
              ...
              <div class="panel-heading" role="tab" id="headingTwo">
                ...
                <h4 class="panel-title">
                  ...
                  <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                    ...
                    <?php echo _l('transfer_tour_included'); ?>
              ...
              <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                ...
                <div class="panel-body">
                  ...
                  <div class="form-group">
                    ...
                    <label class="col-form-label label_text text-lg-right"><?php _el('transfer_tour_included'); ?></label>

                    <textarea id="tour_included" name="tour_included" placeholder="<?php _el('transfer_tour_included'); ?>"><?php echo $toursData['tour_included']; ?></textarea>
              ...
              <div class="panel-heading" role="tab" id="headingthree">
                ...
                <h4 class="panel-title">
                  ...
                  <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse3" aria-expanded="false" aria-controls="collapse3">
                    ...
                    <?php _el('transfer_tour_restrictions'); ?>
                ...
                <div class="panel-body tour_restrictions">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-10">
                      ...
                      <button name="add_restriction" id="add_restriction" type="button" class="btn btn-primary"><?php echo _l('transfer_add_restriction'); ?></button>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-10">
                          ...
                          if ($i == 0) { ?>
                            ...
                            <label class="col-form-label label_text text-lg-right"><?php _el('transfer_tour_restrictions'); ?><small class="req text-danger">*</small></label><?php } ?>

                          <input type="text" class="form-control tour_res_input required" name="tour_restrictions[<?php echo $i; ?>]" autocomplete="off" placeholder="<?php _el('transfer_tour_restrictions'); ?>" value="<?php echo $res; ?>">
              ...
              <div class="panel-heading" role="tab" id="heading4">
                ...
                <h4 class="panel-title">
                  ...
                  <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse4" aria-expanded="false" aria-controls="collapse4">
                    ...
                    <?php _el('transfer_tour_meeting_point'); ?>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-10">
                          ...
                          if ($m == 0) { ?>
                            ...
                            <label class="col-form-label label_text text-lg-right"><?php _el('transfer_tour_meeting_point'); ?><small class="req text-danger">*</small></label>

                          <?php } ?>

                          <input type="text" class="form-control tour_meeting_input required" name="tour_meeting_point[<?php echo $m; ?>]" autocomplete="off" placeholder="<?php _el('transfer_tour_meeting_point'); ?>" value="<?php echo $meet; ?>">
              ...
              <div id="collapse5" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading5">
                ...
                <div class="panel-body tour_faqs">
                  ...
                  <!--  <div class="form-group">
                                     ...
                                     <label  class="col-form-label label_text text-lg-right"><?php _el('transfer_tour_faqs'); ?><small class="req text-danger">*</small></label>
              ...
              <div class="panel-heading" role="tab" id="headingThree">
                ...
                <h4 class="panel-title">
                  ...
                  <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                    ...
                    <?php _el('transfer_tour_cancellation_policy'); ?>
              ...
              <div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
                ...
                <div class="panel-body">
                  ...
                  <div class="form-group">
                    ...
                    <label class="col-form-label label_text text-lg-right"><?php _el('transfer_tour_cancellation_policy'); ?></label>
              ...
              <div class="panel-heading" role="tab" id="heading7">
                ...
                <h4 class="panel-title">
                  ...
                  <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse7" aria-expanded="false" aria-controls="collapseTwo">
                    ...
                    <?php echo _l('transfer_tour_email_description'); ?>
              ...
              <div id="collapse7" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                ...
                <div class="panel-body">
                  ...
                  <div class="form-group">
                    ...
                    <label class="col-form-label label_text text-lg-right"><?php _el('transfer_tour_email_description'); ?></label>

                    <textarea id="tour_email_description" name="tour_email_description"><?php echo $toursData['tour_email_description']; ?></textarea>
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <label class="col-form-label label_text text-lg-right "><?php _el('transfer_tour_featured_image'); ?><small class="req text-danger">*</small></label>

                <input type="file" id="tour_featured_image" class="form-control" name="tour_featured_image" autocomplete="off" placeholder="<?php _el('transfer_tour_featured_image'); ?>">
                ...
                <?php if ($toursData['feature_image'] != "") { ?>
                  ...
                  <div id="feature_img_show" class="mr-t-5">
                    ...
                    <!-- <a href="<?php //echo base_url('uploads/'.$toursData['feature_image']); 

                                  ?>" class="imgClass" target="_blank"><img src="<?php //echo base_url('uploads/'.$toursData['feature_image']);

                                                                                  ?>" width="50" height="50" onerror="this.src='<?php //echo base_url("assets/images/default/transfers_default.png");

                                                                                                                                ?>'"></a> -->

                    <!-- <button title="close" type="button" class="btn remove_feature_img" value="<?php //echo base64_encode($toursData['id']);

                                                                                                    ?>" data-imgname="<?php //echo $toursData['feature_image']; 
            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <label class="col-form-label label_text text-lg-right "><?php _el('transfer_tour_banner_image'); ?><small class="req text-danger">*</small></label>

                <input type="file" id="tour_banner_image" class="form-control" name="tour_banner_image" autocomplete="off" placeholder="<?php _el('transfer_tour_banner_image'); ?>">
                ...
                <?php if ($toursData['banner_image'] != "") { ?>
                  ...
                  <div id="banner_img_show" class="mr-t-5">
                    ...
                    <!-- <a href="<?php //echo base_url('uploads/'.$toursData['banner_image']); 

                                  ?>" class="imgClass" target="_blank"><img src="<?php //echo base_url('uploads/'.$toursData['banner_image']);
        ...
        <div class="form-group">
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <label class="col-form-label label_text text-lg-right"><?php _el('transfer_tour_gallery_image'); ?><small class="req text-danger">*</small></label>

              <input type="file" id="tour_gallery_image" class="form-control" name="tour_gallery_image[]" autocomplete="off" placeholder="<?php _el('transfer_tour_gallery_image'); ?>" multiple>

              <small class="text-info"><strong>*<?php echo _l('upload_multiple_files'); ?></strong></small>

              <input type="hidden" name="tour_gallery_img" id="tour_gallery_img" value="<?php if ($toursData['gallery_image'] != '') {

                                                                                          echo count(explode(',', $toursData['gallery_image']));
          ...
          <fieldset class="">
            ...
            <div class="col-md-12">
              ...
              <div class="form-group">
                ...
                <div class="col-lg-9 col-md-9 col-sm-12">
                  ...
                  <div class="radio-inline chk_topsell">
                    ...
                    <input type="radio" name="top_selling_tour" <?php if ($toursData['top_selling_tour'] == 1) {

                                                                  echo "checked";

                                                                } ?> value="1"><?php echo _l('yes'); ?>

                  </div>

                  <div class="radio-inline chk_topsell">

                    <input type="radio" name="top_selling_tour" <?php if ($toursData['top_selling_tour'] == 0) {

                                                                  echo "checked";

                                                                } ?> value="0"><?php echo _l('no'); ?>
              ...
              <div class="form-group">
                ...
                <label class="col-form-label label_text text-lg-right col-md-3 col-lg-3 col-sm-12"><?php echo _l('upselling_tours'); ?>:</label>

                <div class="col-lg-9 col-md-9 col-sm-12">

                  <div class="radio-inline chk_upsell">

                    <input type="radio" name="upselling_tour" <?php if ($toursData['upselling_tours'] == 1) {
                  ...
                  <div class="radio-inline chk_upsell">
                    ...
                    <input type="radio" name="upselling_tour" <?php if ($toursData['upselling_tours'] == 0) {
              ...
              <div class="form-group">
                ...
                <div class="col-lg-9 col-md-9 col-sm-12 rating">
                  ...
                  <fieldset class="rate">
                    ...
                    <input type="radio" id="rating10" name="rating" value="5" <?php if ($toursData['rating'] == 5) {

                                                                                echo "checked";

                                                                              } ?> /><label for="rating10" title="5 stars"></label>

                    <input type="radio" id="rating9" name="rating" value="4.5" <?php if ($toursData['rating'] == '4.5') {

                                                                                  echo "checked";

                                                                                } ?> /><label class="half" for="rating9" title="4.5 stars"></label>

                    <input type="radio" id="rating8" name="rating" value="4" <?php if ($toursData['rating'] == 4) {

                                                                                echo "checked";

                                                                              } ?> /><label for="rating8" title="4 stars"></label>

                    <input type="radio" id="rating7" name="rating" value="3.5" <?php if ($toursData['rating'] == '3.5') {

                                                                                  echo "checked";

                                                                                } ?> /><label class="half" for="rating7" title="3.5 stars"></label>

                    <input type="radio" id="rating6" name="rating" value="3" <?php if ($toursData['rating'] == 3) {

                                                                                echo "checked";

                                                                              } ?> /><label for="rating6" title="3 stars"></label>

                    <input type="radio" id="rating5" name="rating" value="2.5" <?php if ($toursData['rating'] == '2.5') {

                                                                                  echo "checked";

                                                                                } ?> /><label class="half" for="rating5" title="2.5 stars"></label>

                    <input type="radio" id="rating4" name="rating" value="2" <?php if ($toursData['rating'] == 2) {

                                                                                echo "checked";

                                                                              } ?> /><label for="rating4" title="2 stars"></label>

                    <input type="radio" id="rating3" name="rating" value="1.5" <?php if ($toursData['rating'] == '1.5') {

                                                                                  echo "checked";

                                                                                } ?> /><label class="half" for="rating3" title="1.5 stars"></label>

                    <input type="radio" id="rating2" name="rating" value="1" <?php if ($toursData['rating'] == 1) {

                                                                                echo "checked";

                                                                              } ?> /><label for="rating2" title="1 star"></label>

                    <input type="radio" id="rating1" name="rating" value="0.5" <?php if ($toursData['rating'] == '0.5') {

                                                                                  echo "checked";

                                                                                } ?> /><label class="half" for="rating1" title="0.5 star"></label>

                    <input type="radio" id="rating0" name="rating" value="0" <?php if ($toursData['rating'] == '0') {

                                                                                echo "checked";

                                                                              } ?> /><label for="rating0" title="No star" class="rate0"></label>
                    ...
                    ?>
                      ...
                      <div class="col-lg-4 col-md-4 col-sm-12">
                        ...
                        <div class="checkbox">
                          ...
                          <label><input type="checkbox" name="extra_services[]" value="<?php echo $ex['id']; ?>" <?php if (in_array($ex['id'], $tour_extra_service)) {

                                                                                                                    echo "checked";

                                                                                                                  } ?>><?php echo $ex['title']; ?></label>
              ...
              <!-- Extra cost section start -->

              <?php

              if (is_array($extra_cost) && sizeof($extra_cost) > 0) { ?>

                <div class="form-group">

                  <label class="col-form-label label_text text-lg-right col-md-3 col-lg-3 col-sm-12"><?php echo _l('extra_cost'); ?>:</label>

                  <div class="col-lg-9 col-md-9 col-sm-12">

                    <?php

                    $tour_extra_service = explode(",", $toursData['extra_costs_id']);

                    foreach ($extra_cost as $k_index => $ex) {
                      ...
                      <div class="col-lg-4 col-md-4 col-sm-12">
                        ...
                        <div class="checkbox">
                          ...
                          <label>
                            ...
                            <input type="checkbox" name="extra_cost[]" value="<?php echo $ex['id']; ?>" <?php echo (in_array($ex['id'], $tour_extra_service)) ? "checked" : ""; ?>>
    ...
    <div class="msf-navigation">
      ...
      <div class="row">
        ...
        <div class="col-md-3 col-md-offset-6">
          ...
          <a class="btn btn-default hidden cancel_tour_edit" href="<?php echo admin_url('tours'); ?>"><?php _el('cancel'); ?></a>
