...
<div id="add_transfer_category_modal" class="modal fade" data-backdrop="static">
    <div class="modal-dialog" width="50px">
        <div class="modal-content">
            ...
            <form id="addTransferCategoryform" method="POST" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-6">
                                <label  class="col-form-label label_text text-lg-right "><?php echo _l('transfer_category'); ?><small class="req text-danger">*</small></label>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="hidden" id="featured_img" class="form-control " name="featured_img" autocomplete="off" >
