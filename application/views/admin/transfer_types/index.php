...
<div class="page-header">
    <div class="page-header-content">
        <div class="page-title">
            <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold"><?php echo _l('transfer_types'); ?></span></h4>
        </div>
    ...
    <div class="breadcrumb-line breadcrumb-line-component">
        <ul class="breadcrumb">
            ...
            <li class="active"><?= _l('transfer_types'); ?></li>
        </ul>
...
<div class="content">
    ...
    <div class="panel panel-flat">
        ...
        <!-- <div class="panel-heading"> -->
            ...
            <!-- <a href="<?php //echo admin_url('tour_types/add'); ?>" class="btn btn-primary"><?php //_el('add_new'); ?><i class="icon-plus-circle2 position-right"></i></a> -->
        <!-- </div> -->
        <!-- /Panel heading -->
        <!-- <div class="row"> -->
            <!-- <div class="col-sm-12"> -->
