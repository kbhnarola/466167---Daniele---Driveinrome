        ...
        <div class="panel panel-flat">
          ...
          <div class="panel-body">
            <div class="custom-form">
              <form action="<?php echo admin_url('transfers/edit/'.base64_encode($transferData['id'])); ?>" id="editTransferServiceform" method="POST" enctype="multipart/form-data">
                ...
                <fieldset>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="row div_span">
                                ...
                                <textarea rows="7" name="description" id="description" class="form-control resize_box"><?php echo $transferData['description'];?></textarea>
                  ...
                  <div class="form-group">
                      <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="hidden" id="feature_img" class="form-control" name="feature_img" autocomplete="off" value="<?php echo $transferData['feature_image']; ?>">
                            <?php 
                            if($transferData['feature_image']){ ?>
                            <a href="<?php echo base_url().'uploads/'.$transferData['feature_image'];?>" class="imgClass" id="view_feature_img" target="_blank" style="color:blue">View Feature Image</a>
                            <?php } ?>
                        </div>
                      </div>
                  </div>
                  ...
                  <div class="form-group mr-t-5">
                    <div class="row">
                      <div class="col-md-12">
                        ...
                        <textarea id="transfer_email_description" name="transfer_email_description"><?=$transferData['transfer_email_description']?></textarea>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="btn-bottom-toolbar text-center btn-toolbar-container-out">
                      ...
                      <a class="btn btn-default cancel_transfer_edit" href="<?php echo admin_url('transfers');?>"><?php _el('cancel'); ?></a>
                    </div>
                  </div>
                </fieldset>
              </form>
