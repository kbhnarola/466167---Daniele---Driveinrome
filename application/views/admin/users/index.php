...
<style type="text/css">
    /*.note-editor{font-family:'Times New Roman';font-size: 18px;}*/
    /*.note-editor{font-family:'Roboto';}*/
</style>
...
<div class="content">
            ...
            <div class="panel panel-flat">
                <div class="panel-body tag-filter-wrap">
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-6">
                                <select id="tag_name" name="tag_name" class="form-control select_group" placeholder="<?php echo 'Select a Tag for filter'; ?>">
                                    <option></option>
                                    <option value="notag">- NO TAGS -</option>
                                    <?php
                ...
                <div class="panel-heading">
                    <form method="post" id="import_csv" action="<?php echo admin_url('users/import_users'); ?>" enctype="multipart/form-data">
                        <div class="frm-import-users">
                            ...
                            <input type="button" name="add_user" class="btn btn-info" id="add_user_btn" value="Add User">
                        </div>
                    </form>
                </div>
            </div>
    ...
    <div class="panel panel-flat">
        <div class="panel-body diff-btn-wrapper">
            ...
            <a href="#" onclick="return false;" class="btn btn-info" data-toggle="modal" data-target="#newsletter" id="newsletter_selected">Send Newsletter to Selected<i style="margin-left:10px;" class="fa fa-paper-plane"></i></a>
            <!-- </div> -->
            <!-- <div class="col-md-3"> -->
...
<!-- Start modal popup -->
<div id="newsletter" class="modal fade" role="dialog" style="display: none !important;" data-backdrop="static" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <form id="addNewsletterContent" method="POST" enctype="multipart/form-data">
                <div class="modal-body" style="max-height: 800px">
                    ...
                    <div id="default_newsletter_form">
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-6">
                                    <label class="col-form-label label_text text-lg-right ">Select Tag<small class="req text-danger">*</small></label>
                                    <select id="select_tag_name_filter" name="select_tag_name_filter[]" class="form-control" placeholder="<?php echo 'Select a Tag'; ?>" multiple="true">
                                        <!-- <option></option> -->
                                        <?php
                                        if (!empty($all_active_tags)) {
                                            foreach ($all_active_tags as $single_tag) {
                                        ?>
                                                <option value="<?php echo $single_tag['tag_id']; ?>"><?= strtoupper($single_tag['tag_name']) ?></option>
                                        <?php
                                            }
                                        }
                                        ?>
                                    </select>
                                    <div id="select_tag_err"></div>
                                </div>
                                <div class="col-md-6">
                                    <label class="col-form-label label_text text-lg-right ">Newsletter Subject<small class="req text-danger">*</small></label>
                                    <select id="select_newsletter_subject" name="select_newsletter_subject" class="form-control" placeholder="Select Newsletter Subject">
                                        <option value="">Select Newsletter Subject</option>
                                        <?php
                                        foreach ($newsletter_subject_list as $c) {
                                            if ($c['newsletter_subject']) { ?>
                                                <option value="<?php echo $c['id']; ?>"><?php echo $c['newsletter_subject']; ?></option>
                                        <?php }
                                        }
                                        ?>
                                    </select>
                                    <div id="select_nls_err"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div id="create_newsletter_form" class="hidden">
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-6">
                                    <label class="col-form-label label_text text-lg-right ">Select Tag<small class="req text-danger">*</small></label>
                                    <select id="select_tag_name" name="select_tag_name[]" class="form-control" placeholder="<?php echo 'Select a Tag'; ?>" multiple="true">
                                        <!-- <option></option> -->
                                        <?php
                                        if (!empty($all_active_tags)) {
                                            foreach ($all_active_tags as $single_tag) {
                ...
                <div class="modal-footer text-center">
                    ...
                    <button type="button" class="btn btn-success hidden" id="preview_newsletter">Preview Newsletter</button>
                    <button type="button" class="btn btn-success" id="preview_newsletter_default">Preview Newsletter</button>
                    <button type="submit" class="btn btn-primary" id="send_newsletter">Send Newsletter</button>
                    <!-- </div> -->
            ...
            <form id="editUserdetailsform" method="POST" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-6">
                                <label class="col-form-label label_text text-lg-right ">Full Name<small class="req text-danger">*</small></label>
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="text" id="edit_user_phone" class="form-control" name="edit_user_phone" autocomplete="off" placeholder="Phone number" maxlength="15">
                            </div>
                            <div class="col-md-6">
                                <label class="col-form-label label_text text-lg-right ">Add Tag</label>
                                <input type="text" id="edit_user_tag" class="form-control" name="edit_user_tag" autocomplete="off" placeholder="Add Tag">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-12">
                                <label class="col-form-label label_text text-lg-right ">Notes</label>
                                <textarea id="edit_user_notes" class="form-control" name="edit_user_notes" rows="4" cols="50" autocomplete="off" placeholder="">
                                    </textarea>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-footer text-center">
                    <input type="hidden" class="form-control" id="edit_user_id" name="edit_user_id"><button name="tour_category_submit" type="submit" id="edit_user_details" class="btn btn-primary"><?php _el('update'); ?></button>
                    <button type="button" class="btn btn-default" data-dismiss="modal"><?php _el('cancel'); ?></button>
                </div>
            </form>
...
<div id="addUserInfoModal" class="modal fade" data-backdrop="static">
    <div class="modal-dialog" width="60px">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <button type="button" class="close add_user_close" data-dismiss="modal">&times;</button>
                <h5 class="modal-title">Add User</h5>
            </div>

            <form id="addUserdetailsform" name='addUserdetailsform' method="POST" action="<?php echo admin_url('users/import_user'); ?>" enctype="multipart/form-data">
                <div class="modal-body">
                    <div class="alert alert-danger hidden" id="error_user_det">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-6">
                                <label class="col-form-label label_text text-lg-right ">Full Name<small class="req text-danger">*</small></label>
                                <input type="text" id="add_username" class="form-control" name="add_username" autocomplete="off" placeholder="Username">
                            </div>
                            <div class="col-md-6">
                                <label class="col-form-label label_text text-lg-right ">Email<small class="req text-danger">*</small></label>
                                <input type="text" id="add_user_email" class="form-control" name="add_user_email" autocomplete="off" placeholder="Email">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-6">
                                <label class="col-form-label label_text text-lg-right ">Phone Number</label>
                                <input type="text" id="add_user_phone" class="form-control" name="add_user_phone" autocomplete="off" placeholder="" maxlength="15">
                            </div>
                            <div class="col-md-6">
                                <label class="col-form-label label_text text-lg-right ">Add Tag</label>
                                <input type="text" id="add_user_tag" class="form-control" name="add_user_tag" autocomplete="off" placeholder="">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="modal-footer text-center">
                    <input type="hidden" class="form-control" id="add_user_id" name="add_user_id">
                    <button name="tour_category_submit" type="submit" id="add_user_details" class="btn btn-primary">Save</button>
                    <button type="button" class="btn btn-default add_user_close" data-dismiss="modal"><?php _el('close'); ?></button>
                </div>
            </form>
            <div class="text-center hidden" id="loader_cont_user_det">
                <img src="<?php echo ASSET . 'images/loader.gif'; ?>">
...
<script>
    ...
    jQuery("#select_newsletter_subject").select2({
        placeholder: "Select Newsletter Subject",
    });

    jQuery("#select_tag_name_filter").select2({
        placeholder: "Select Tag",
    });

    jQuery("#select_tag_name").select2({
        placeholder: "Select Tag",
    });

    jQuery(document).on("change", "#default_newsletter_opt", function() {

        // jQuery("#default_newsletter_form").removeClass("hidden");
        // jQuery("#create_newsletter_form").addClass("hidden");
        // jQuery("#preview_newsletter").addClass("hidden");
        // jQuery("#preview_newsletter_default").removeClass("hidden");
        // jQuery("#select_tag_name_filter").prop("disabled", false);
        // jQuery("#select_newsletter_subject").prop("disabled", false);

        var validator = $("#addNewsletterContent").validate();
        validator.resetForm();

    });
    jQuery(document).on("change", "#create_new_newsletter_opt", function() {

        // jQuery("#default_newsletter_form").addClass("hidden");
        // jQuery("#create_newsletter_form").removeClass("hidden");
        // jQuery("#preview_newsletter").removeClass("hidden");
        // jQuery("#preview_newsletter_default").addClass("hidden");
        // jQuery("#select_tag_name").prop("disabled", false);
        // jQuery("#select_newsletter_subject").prop("disabled", true);
        var validator = $("#addNewsletterContent").validate();
        validator.resetForm();
    });
    jQuery("#select_newsletter_subject").select2().change(function() {
        jQuery(this).valid();
    });
    jQuery("#select_tag_name_filter").select2().change(function() {

        jQuery(this).valid();
        if ($(this).val() != "") {
            jQuery("#select_tag_name").prop("disabled", true);
        } else {
            jQuery("#select_tag_name").prop("disabled", false);
        }
    });

    jQuery("#select_tag_name").select2().change(function() {

        jQuery(this).valid();
        if ($(this).val() != "") {
            // jQuery("#select_tag_name_filter").prop("disabled", true);
        } else {
            jQuery("#select_tag_name_filter").prop("disabled", false);
        }
    });
    ...
    function fetch_data() {
        ...
        jQuery(document).on('click', 'button.btn.bg-pink', function(event) {
            jQuery("#tag_name").val('').trigger('change');
    ...
    jQuery("#addNewsletterContent").validate({
        errorElement: 'span',
        rules: {
            'select_tag_name_filter[]': "required",
            'select_tag_name[]': "required",
            newsletter_send_by_opt: "required",
            newsletter_subject: {
                required: true,
                noSpace: true,
                noHTMLtags: true,
            ...
            'select_newsletter_subject': "required"
            // tour_image1_url:{
            //    required:true
            // }
        },
        errorPlacement: function(error, element) {
            ...
            if (element.attr("name") == "newsletter_send_by_opt") {
                error.appendTo("#select_nl_opt");
            } else if (element.attr("name") == "select_newsletter_subject") {
                error.appendTo("#select_nls_err");
            } else if (element.attr("name") == "select_tag_name_filter[]") {
                error.appendTo("#select_tag_err");
            } else if (element.attr("name") == "select_tag_name[]") {
                error.appendTo("#select_tag_err1");
            } else {
                error.insertAfter(element)
            }
        },
            ...
            jQuery.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.success == false) {
                        ...
                        if (jQuery("#select_newsletter_subject").length) {
                            $("#select_newsletter_subject").val('').trigger('change');
                        }
                        if (response.newsletter_id) {
                            //var newState = new Option(response.newsletter_id, response.newsletter_subject, true, true);
                            var n_l = '<option value="' + response.newsletter_id + '">' + response.newsletter_subject + '</option>';
                            // Append it to the select
                            $("#select_newsletter_subject").append(n_l).trigger('change');
                        }
                        var validator = $("#addNewsletterContent").validate();
                        validator.resetForm();
                        $('#newsletter_content').summernote('reset');
                        ...
                        $('#users_list_table').DataTable().ajax.reload();
                        jGrowlAlert(response.message, 'success', true);
                    }
                },
            ...
            jQuery.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.success == false) {
                        ...
                        x.document.body.setAttribute('style', 'font-family: Montserrat !important');
    ...
    jQuery(document).on('click', '#preview_newsletter_default', function() {
        if ($("#addNewsletterContent").valid()) {
            var ajaxSubmit = BASE_URL + 'users/preview_newsletter_default';
            var form1 = $('#addNewsletterContent')[0];
            var formData = new FormData(form1);
            jQuery.ajax({
                url: ajaxSubmit,
    ...
    $('#newsletter').on('hidden.bs.modal', function() {
        jQuery("#addNewsletterContent")[0].reset();
        jQuery("#select_newsletter_subject").val('').trigger('change');
        jQuery("#select_tag_name_filter").val('').trigger('change');
        jQuery("#select_tag_name").val('').trigger('change');
        // jQuery("#default_newsletter_form").addClass('hidden');
        jQuery("#create_newsletter_form").addClass("hidden");
        jQuery("#preview_newsletter").addClass("hidden");
    ...
    jQuery("#import_csv").validate({
        ...
        messages: {
            users_csv: {
                required: 'Please upload csv or xlsx file',
                extension: 'Please upload csv or xlsx file only',
            },
        },
        errorPlacement: function(error, element) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data.id) {
                    ...
                    jQuery("#edit_user_tag").val(data.tag_name);
                    jQuery("#edit_user_notes").val(data.notes);
    ...
    jQuery(document).on('click', '#add_user_btn', function() {
        jQuery("#addUserInfoModal").modal('show');
    });
    jQuery(document).on('click', '#add_user_details', function() {

        $("#addUserdetailsform").validate();

    });
    jQuery(document).on('click', '.add_user_close', function() {


        $("#addUserdetailsform").validate().resetForm();


        // $("#addUserdetailsform")[0].reset();
        // $('#addUserdetailsform').trigger("reset");
        // jQuery("#addUserdetailsform")[0].reset();
        // $("#addUserdetailsform").get(0).reset();

    });

    jQuery("#addUserdetailsform").validate({
        errorElement: 'span',
        rules: {
            add_username: {
                required: true,
        ...
        submitHandler: function(form) {
            $("#add_user_details").attr("disabled", true);
            form.submit();
        }
    });
</script>