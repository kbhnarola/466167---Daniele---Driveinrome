            ...
            <div class="panel panel-flat">
                <div class="panel-body tag-filter-wrap">
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-6">                        
                                <select id="tag_name_filter" name="tag_name_filter[]" class="form-control select_group" placeholder="<?php echo 'Select a Tag for filter';?>" multiple>
                                    <option></option>
                                <?php
        ...
        <form  id="addNewsletterContent" method="POST" enctype="multipart/form-data">
            <div class="modal-body" style="max-height: 800px">
                ...
                <div class="form-group mr-t-5">
                    <div class="row">
                        <div class="col-md-6">
                            <label class="col-form-label label_text text-lg-right">Select Newsletter Send By<small class="req text-danger">*</small></label>
                            <div class="" > 
                                <label class="radio-inline col-form-label label_text">
                                    <input type="radio" id="default_newsletter_opt" name="newsletter_send_by_opt" value="1">Saved Newsletter
                                </label>
                                <label class="radio-inline col-form-label label_text">
                                    <input type="radio" id="create_new_newsletter_opt" name="newsletter_send_by_opt" value="2">Create New
                                </label>
                            </div>
                            <div id="select_nl_opt"></div>
                        </div>
                    </div>
                </div>
                
                <div class="hidden" id="default_newsletter_form">
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-6">
            ...
            <div class="modal-footer text-center">
                <!-- <div class="modal-form"> -->
                    ...
                    <button type="button" class="btn btn-success hidden" id="preview_newsletter_default">Preview Newsletter</button>
