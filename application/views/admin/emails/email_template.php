...
<div class="page-header page-header-default">
	...
	<div class="breadcrumb-line">
		<ul class="breadcrumb">
			...
			<li>
				<a href="<?php echo admin_url('emails'); ?>">Email Templates</a>
			</li>
...
<!-- Content area -->
<div class="content">
	<form action="<?php echo admin_url('emails/email_template/').base64_encode($template['id']); ?>" id="templateform" method="POST">
		<div class="row">
			<div class="col-md-6">
				<!-- Panel -->
						...
						<div class="row">
							<div class="col-md-12">
								<h5 class="panel-title">
									<strong>Edit Template: <?php echo $template['name']; ?></strong>
								</h5>
								<hr/>
							</div>
						</div>
