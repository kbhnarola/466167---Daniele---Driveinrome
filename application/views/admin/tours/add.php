...
<div class="content ">
  ...
  <form class="form-horizontal msf" id="addTourform" method="post" enctype="multipart/form-data" action="<?php echo admin_url('tours/add'); ?>">
            ...
            <div class="col-md-6">
              ...
              <select id="tour_type" name="tour_type" class="form-control">
                ...
                foreach ($tour_types as $j) {
                  // exlude the 'Transfer' and 'Shared transfer' tour type
                  if ($j['id'] == 9 || $j['id'] == 10) {
                    continue;
                  }
                ?>
                  ...
                  <div class="col-lg-9 col-md-9 col-sm-12">
                    ...
                    ?>
                      <div class="col-lg-4 col-md-4 col-sm-12">
                        <div class="checkbox">
                          <label>
                            <input type="checkbox" name="extra_cost[]" value="<?php echo $ex['id']; ?>">
                            <?php echo $ex['title']; ?>
                          </label>
                        </div>
                      </div>
