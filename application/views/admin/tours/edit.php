  ...
  <div class="breadcrumb-line">
    ...
    <ul class="breadcrumb">
      ...
      <li>
        ...
        <a href="<?php echo admin_url('tours'); ?>"><i class="icon-home2 position-left"></i><?php _el('manage_tour'); ?></a>
...
<div class="content ">
  ...
  <form class="form-horizontal msf" id="editTourform" method="post" enctype="multipart/form-data" action="<?php echo admin_url('tours/edit/' . base64_encode($toursData['id'])); ?>">
    ...
    <div class="msf-header">
      ...
      <div class="row text-center">
        ...
        <div class="msf-step col-md-3" data-id="1"><i class="fa fa-info"></i> <span><?php echo _l('basic_tour_details'); ?></span></div>

        <div class="msf-step col-md-3" data-id="2"><i class="fa fa-file-text" aria-hidden="true"></i><span><?php echo _l('tour_description'); ?></span></div>

        <div class="msf-step col-md-3" data-id="3"><i class="fa fa-image"></i> <span><?php echo _l('tour_images'); ?></span></div>

        <div class="msf-step col-md-3" data-id="4"><i class="fa fa-money" aria-hidden="true"></i> <span><?php echo _l('tour_price'); ?></span></div>
              ...
              <div class="panel-heading" role="tab" id="heading7">
                ...
                <h4 class="panel-title">
                  ...
                  <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse7" aria-expanded="false" aria-controls="collapseTwo">
                    ...
                    <?php echo _l('tour_email_description'); ?>
              ...
              <div id="collapse7" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                ...
                <div class="panel-body">
                  ...
                  <div class="form-group">
                    ...
                    <label class="col-form-label label_text text-lg-right"><?php _el('tour_email_description'); ?></label>
