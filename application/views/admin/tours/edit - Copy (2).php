                        ...
                        <div class="form-group">
                           ...
                           <div class="form-group">
                              <label  class="col-form-label label_text text-lg-right"><?php _el('tour_restrictions'); ?><small class="req text-danger">*</small></label>
                                ...
                                <textarea rows="7" id="tour_restrictions" class="form-control resize_box" name="tour_restrictions" placeholder="<?php _el('tour_restrictions');?>" value="<?php echo $toursData['tour_restrictions'];?>"><?php echo $toursData['tour_restrictions'];?></textarea>
                    ...
                    <div class="col-md-6">
                           <div class="form-group">
                              <label  class="col-form-label label_text text-lg-right "><?php _el('tour_meeting_point'); ?><small class="req text-danger">*</small></label>
                                ...
                                <textarea rows="7" id="tour_meeting_point" class="form-control resize_box" name="tour_meeting_point" placeholder="<?php _el('tour_meeting_point');?>" value="<?php echo $toursData['tour_meeting_point'];?>"><?php echo $toursData['tour_meeting_point'];?></textarea>
                              
                          </div>
                           <div class="form-group">
                              <label  class="col-form-label label_text text-lg-right"><?php _el('tour_faqs'); ?><small class="req text-danger">*</small></label>
                              
                                <textarea rows="7" id="tour_faqs" class="form-control resize_box" name="tour_faqs" placeholder="<?php _el('tour_faqs');?>" value="<?php echo $toursData['tour_faqs'];?>"><?php echo $toursData['tour_faqs'];?></textarea>
                  ...
                  <div class="row">
                    <fieldset class="basic_price">
                        <?php 
                            ...
                            <?php $i++; } } }?> 
                            <div class="col-md-3"><div class="form-group"> <button type="button" class="btn btn-primary" name="add_custom_price" id="add_custom_price">Add More</button></div></div>                                                 
                    </fieldset>                    
                  </div>
                  
                  <div class="row bs_price">
                                  ...
                                  if($v['price_type']==2) { ?>
                                    <?php 
                                      ...
                                      <div class="row cs_price">
                                        <div class="col-md-3">
                                          <div class="form-group"> 
                                            <label class="col-form-label label_text text-lg-right">Select Date<small class="req text-danger">*</small></label><div class="input-group date tour_datepicker" > 
                                              <input type="text" name="tour_date[<?php echo $j;?>]" class="form-control required tour_date" placeholder="Select Date" value="<?php echo $v['tour_date'];?>">
                                              <div class="input-group-addon" value="<?php echo $v['tour_date'];?>"> 
