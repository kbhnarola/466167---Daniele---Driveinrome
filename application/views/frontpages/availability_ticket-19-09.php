...
<div class="breadcrumb n-breadcrumb">
    <div class="container">
      ...
      ?> 
      &nbsp&nbsp/&nbsp&nbsp<a href="<?php echo base_url('tours/'.$toursData['toursData']['tour_slug']);?>"><?php echo $toursData['toursData']['title'];?></a>&nbsp&nbsp/&nbsp&nbsp<span class="title">Tour Upgrades</span></p>
    </div>
</div>
          ...
          <div class="custom-form">
            <form method="post" id="addTourUpgrades" action="<?php echo base_url('add_tour_upgrades');?>">
                        ...
                        if(in_array($ex['id'], $ex_services)) { 
                            ...
                            <li>
                              <div class="custom-checkbox">
                                <?php echo $ex['title'];?>
                                <input type="checkbox" name="tour_upgrades[]" class="select_tour_upgrades" value="<?php echo $ex['id'];?>" <?php if(in_array($ex['id'],$tour_upgrades_cart)){ echo "checked";}?>>
                                            ...
                                            <div class="row">  
                                              <div class="col-md-4 field-group">
                                                <div class="form-group">
                                                  <fieldset>
                                                    <legend>First Name</legend> 
                                                    <input type="text" class="form-control fname_tour_up fieldset_element " name=" first_name[<?php echo $ex['id'];?>][<?php echo $i;?>]" data-id="<?php echo $ex['id'];?>" autocomplete="off" value="<?php echo $tour_upgrades_passenger_detail['first_name'][$ex['id']][$i];?>"></fieldset>
                                                  </div>
                                              </div>
                                              <div class="col-md-4 field-group">
                                                  <div class="form-group">
                                                    <fieldset>
                                                      <legend>Last Name</legend> 
                                                      <input type="text" class="form-control lname_tour_up fieldset_element " name="last_name[<?php echo $ex['id'];?>][<?php echo $i;?>]" autocomplete="off" data-id="<?php echo $ex['id'];?>" value="<?php echo $tour_upgrades_passenger_detail['last_name'][$ex['id']][$i];?>"></fieldset>
                                                    </div>
                                              </div>
                                              <div class="col-md-4 field-group">
                                                    <div class="form-group">
              ...
              <div class="button-wrap">
                <a href="<?php echo base_url('tours/'.$toursData['toursData']['tour_slug']);?>" class="btn btn-border">Go Back</a>
