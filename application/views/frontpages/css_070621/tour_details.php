    ...
    <div class="breadcrumb">
      <div class="container">
        ...
        <?php
          ...
          elseif ($toursData['tour_type_id']==8) { 
          ?>
        ...
        <?php 
          ...
          ?>
          &nbsp&nbsp/&nbsp&nbsp<span class="title"><?php echo $toursData['title'];?></span></p>         
      </div>
    </div>
  </section>
          ...
          <div class="product-wrap">
                    ...
                    if($toursData['gallery_image']) {
                      ...
                      foreach ($gallery_image as $value) { ?>
                       ...
                       <?php $i++; } }  else { ?>
                        ...
                        <div class="item text-center">
                          <img src="<?php echo base_url('uploads/'.$toursData['feature_image']);?>" alt="<?php echo $toursData['title'];?>" onerror="this.src='<?php echo DEFAULT_IMAGE.'transfers_default.png';?>" class="img-responsive" height="300">
                        </div>
                      <?php } ?>                    
                </div>
            </div>
            <div class="content-div">
              <h2>
                <?php
                if($toursData['tour_type_id']==1 || $toursData['tour_type_id']==7) {?>
                Shore Excursions <?php } elseif ($toursData['tour_type_id']==8) { ?>
                  Package Tours
              ...
              <div class="n-product-detail">
                ...
                <div class="p-info-wrap">
                  <div class="left">
                    ...
                    <p class="duration"><i class="far fa-clock"></i>Duration : <?php echo $toursData['duration'];?><?php if($toursData['tour_type_id'] == 8){ if($toursData['duration']>1){?> Days<?php } else {?> Day<?php } } else { if($toursData['duration']>1){ ?> Hours<?php } else { ?> Hour<?php } }?></p>
                  </div>
                  <div class="right">
                    <?php
                    if($toursData['tour_type_id']!=8){ ?>
                      <div class="price-tag">
                        ...
                        if($toursData['tour_price']){
                          ...
                          if($toursData['tour_type_id']==1){ 
                             echo number_format(($price[3]/8),2).' €'; 
                          } elseif ($toursData['tour_type_id']==3){
                             echo number_format(($price[2]/8),2).' €'; 
                          } elseif ($toursData['tour_type_id']==7) { 
                             echo $price[0].' €';
                          } else {  }  ?>
                          <!-- <input type="hidden" name="tour_base_price" id="tour_base_price" value="<?php //echo $price[0];?>"> -->
                         <?php } else { ?>
                          <!-- <input type="hidden" name="tour_base_price" id="tour_base_price" value="0"> -->
                        <?php } 
                        ?>
            ...
            <form method="post" id="tourAvailabilityForm" class="form-content">
              ...
              <div class="form-group">
                ...
                <div class="input-group datepicker_tour " > 
                    <input type="text" name="tour_date" id="tour_date" class="form-control  tour_datepicker tour_date" placeholder="Select Date" readonly="" autocomplete="off" value="<?php if($tour_date_cart) { echo date('F dS Y',strtotime($tour_date_cart)); } ?>">
                  ...
                  <div class="col-md-6 select2-popup">
                    <fieldset>
                      ...
                      <select readonly class="form-control select_person_group" name="adults" id="adults">
                        ...
                        <?php
                          for($i=1;$i<=8;$i++){ ?>
                          <option value="<?php echo $i;?>" <?php if($total_adult_person==$i){ echo "selected";}?>><?php echo $i;?></option>
                            <?php } ?>
                      </select>
                    </fieldset>
                  </div>
                  <div class="col-md-6 select2-popup">
                    <fieldset>
                      ...
                      <select class="form-control select_person_group" name="kids" id="kids">
                        ...
                        <?php
                          for($i=1;$i<=8;$i++){ ?>
                          <option value="<?php echo $i;?>" <?php if($total_kids==$i){ echo "selected";}?>><?php echo $i;?></option>
                            <?php } ?>
                      </select>
                    </fieldset>
                  </div>
                  <div class="col-md-6 select2-popup">
                    <fieldset>
                      ...
                      <select class="form-control select_person_group" name="senior_person" id="senior_person">
                        ...
                        <?php
                          for($i=1;$i<=8;$i++){ ?>
                          <option value="<?php echo $i;?>" <?php if($total_senior_person==$i){ echo "selected";}?>><?php echo $i;?></option>
                            <?php } ?>
                      </select>
                    </fieldset>
                  </div>
                  <div class="col-md-6 select2-popup">
                    <fieldset>
                      ...
                      <select class="form-control select_person_group" name="infants" id="infants">
                        ...
                        <?php
                          for($i=1;$i<=8;$i++){ ?>
                          <option value="<?php echo $i;?>" <?php if($total_infants==$i){ echo "selected";}?>><?php echo $i;?></option>
                            <?php } ?>
                      </select>
                    </fieldset>
                  </div>
              ...
              <div class="form-group ">
                <label>3. Note</label>
                  <div class="input-group ">
                   ...
                   <fieldset class="tour_avail_fieldset">
                      <legend>Message</legend>
                    <input type="text" name="tour_availability_notes" id="tour_availability_notes" class="form-control" value="<?php echo $tour_notes;?>" autocomplete="off">
                  </fieldset>
                     <?php
                  $content='Please tell us where your service will be starting from.<br>
- If it is a cruise ship, please state the name of the ship (for example, "Carnival Legend").<br>
-If its an airpot, please tell us which one, along with your flight details (for example, "Rome (FCO),Alitalia AZ609 Arriving at 6:50am")<br>
...
<input type="hidden" name="tour_date_1" id="tour_date_1" value="<?php if($tour_date_cart) { echo date('d-m-Y',strtotime($tour_date_cart)); } ?>">
