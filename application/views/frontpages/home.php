          ...
          <div class="video-popup d-none">
            ...
            <div class="popup-content">
              <video class="js-player" loop muted>
                <source src="<?php echo base_url('uploads/home/home-page-video.mp4') ?>" type="video/mp4" class="video-source">
              </video>
              <input type="hidden" name="home_top_video" id="home_top_video" value="<?php echo base_url('uploads/home/home-page-video.mp4') ?>">
                  ...
                  <div class="content-div">
                    ...
                    <div class="discover">
                      <p><i class="far fa-clock"></i>Duration : <?= $tour_list['duration'] ?>
                        <?php
                        if ($tour_type_table_id == 8) {
                          if ($tour_list['duration'] > 1) {
                        ?>
                            Days
                          <?php
                          } else {
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12 col-lg-12 col-xl-6 right-wrapper ">
        ...
        <input type="hidden" value="<?php echo get_settings('home_video') ?>" name="youtube_link" id="youtube_link">
      </div>
      <div class="col-md-12 col-lg-12 col-xl-6 left-wrapper mt-4 mt-xl-0">
        ...
        <div class="description">
          ...
          <p>
            ...
            ?>
            <span id="more">
              <?php echo nl2br($moreDescription) ?>
            </span>
          </p>
...
<script>
  $(document).ready(function() {
    ...
    iframe.setAttribute('src', $('#yt_gallery_link').val());
    ...
    iframe1.setAttribute('src', $('#youtube_link').val());
    iframe1.setAttribute('width', "100%");
    iframe1.setAttribute('height', "100%");
    iframe1.setAttribute('frameborder', "0");

    setTimeout(() => {
      jQuery('#video_galley_popup .modal-body').prepend(iframe);
      jQuery('.video-section .youtube-body').append(iframe1);
      jQuery('.contact-section-wrap').removeClass('d-none');
    }, 5000);
    setTimeout(() => {
      // jQuery('.video-source').attr('src', jQuery('#home_top_video').val());
      jQuery('.video-popup').removeClass('d-none');
    }, 1000);
