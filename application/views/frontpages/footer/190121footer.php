      ...
      <div class="modal-content">
        ...
        <form method="post" id="availabilityForm">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="wrapDiv">
                          ...
                          <div class="right">
                            <a href="javascript:"><i class="far fa-edit edit_tour_person_m"></i>Edit</a>
                          </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="PackageContent">
                      <div class="tour_date_price_slider owl-carousel ">
                        ...
                        while(strtotime($current_date) <= strtotime($endDate)) { ?>
                          <div class="item text-center item_d<?php echo $cnt;?> date_hover" onclick="get_tour_price('<?php echo date("Y-m-d",strtotime($current_date)); ?>','<?php echo $cnt;?>')">
                            <div class="single_tour_date t_dp<?php echo $cnt;?>"><?php echo date('d M Y',strtotime($current_date)); ?></div>
                            <div class="single_tour_price t_dp<?php echo $cnt;?>" data-tour-date="<?php echo date('Y-m-d',strtotime($current_date)); ?>"></div>
                          </div>
          ...
          <div class="modal-footer">
              ...
              <button type="submit" name="continue_tour_add" id="continue_tour_add" class="btn btn-blue" ><?php _el('continue'); ?></button>
          </div>
        </form>
