          ...
          <div class="image-wrap">
            ...
            ?>
              <div class="slider-popup">
                <button class="popup-btn" data-toggle="modal" data-target="#tour_video"><i class="fas fa-play"></i></button>
              </div>
            <?php
            }
            ?>
...
if ($toursData['video_url']) {
?>
  <div id="tour_video" class="modal fade pr-0" role="dialog" data-backdrop="static">
