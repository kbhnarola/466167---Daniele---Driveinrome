  ...
  <div class="breadcrumb">
    <div class="container">
      <p><a href="<?= BASE_URL ?>">Home</a>&nbsp&nbsp/&nbsp&nbsp
        ...
        <?php
        } elseif ($toursData['tour_type_id'] == 9 || $toursData['tour_type_id'] == 10) {
        ?>
              ...
              <h5>
                <?php 
                  if($toursData['tour_type_id'] == 8){
                    ...
                    echo 'From ' . ((!in_array($toursData['tour_type_id'], $transfer_tour_type)) ? 'the Port of ' : '') . str_replace('From', '', $toursData['city']); 
                  }
                ?>
              </h5>
            <?php
            ...
            <div class="n-product-detail">
              ...
              <div class="p-info-wrap">
                <div class="left">
                  ...
                  <p class="duration"><i class="far fa-clock"></i>Duration : <?php echo $toursData['duration']; ?><?php if ($toursData['tour_type_id'] == 8) {
                                                                                                                    if ($toursData['duration'] > 1) { ?> Days<?php } else { ?> Day<?php }
                                                                                                                                                                              } else {
                                                                                                                                                                                if ($toursData['duration'] > 1) { ?> Hours<?php } else { ?> Hour<?php }
                                                                                                                                                                                                                                            } ?></p>
                </div>
                <div class="right">
                  <?php
                      ...
                      <span>*<?php
                              if ($toursData['tour_price']) {
                                ...
                                if ($toursData['tour_type_id'] == 1) {
                                  ...
                                  echo $price[0] . ' €';
                                } elseif (in_array($toursData['tour_type_id'], $transfer_tour_type)) {
          ...
          <form method="post" id="tourAvailabilityForm" class="form-content">
            ...
            <div class="form-group mb-0">
              ...
              <div class="row">
                ...
                <?php
                if (!in_array($toursData['tour_type_id'], $transfer_tour_type)) {
                ?>
                  <div class="col-md-6 select2-popup">
                    <fieldset>
                      ...
                      <select class="form-control select_person_group" name="infants" id="infants">
                        ...
                        <?php
                        for ($i = 1; $i <= 8; $i++) { ?>
                          <option value="<?php echo $i; ?>" <?php if ($total_infants == $i) {
                                                              echo "selected";
                                                            } ?>><?php echo $i; ?></option>
                        <?php } ?>
                      </select>
...
<input type="hidden" name="tour_extra_cost" id="tour_extra_cost" value="<?php echo $toursData['extra_cost']; ?>">
