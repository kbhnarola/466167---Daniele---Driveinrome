<section class="page-title-section">
      <div class="image-wrap">
        <img src="images/product-details.jpg">
      <h1><?php //echo $toursData['city'];?></h1>
    <?php
    echo "<pre>";
    print_r($toursData);
    exit;?>
    <div class="breadcrumb">
      <div class="container">
        <ul>
          <li><a href="#">Home</a></li>
          <li><a href="#"><?php echo $toursData['city'];?></a></li> 
  ...
  <section class="availability-section">
    <div class="container"> 
      <h2 class="title"><?php echo $toursData['city'];?></h2>
      <div class="row">
        <div class="col-md-8">
          <div class="product-wrap">
            <div class="image-wrap">
              <img src="images/pexels-julia-khalimova-4186278.jpg">
            </div>
            <div class="content-div">
              <h2>SHORE EXCURSION</h2>
              <h5>From the Port of Civitavecchia</h5>
              <?php
              ...
              if($extra_services){
                ...
                foreach ($services as $key => $value) {
                  if(in_array($value, $set_extra_services)){
                      $array[]=$set_extra_services[$key];
                  }
                }
              ...
              <div class="n-product-detail">
                ...
                <div class="p-info-wrap">
                  <div class="left">
                    ...
                    <h5 class="code-id"><span>Type : </span><strong>Private</strong></h5>
                    <p class="duration"><i class="far fa-clock"></i>Duration : 9 Hours</p>
                  </div>
                  <div class="right">
                    <div class="price-tag">
                      <img src="images/euro-price-tag.png">
                      Starting From:<br/>
                      <span>*100.00 €</span>
                    </div>
                    <a href="#" class="btn btn-blue">Details</a>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="availability-form form-bg">
            <form>
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  <input type="text" class="form-control">
                  <button  class="popover-button" type="button" data-toggle="popover" data-content="And here's some amazing content. It's very engaging. Right?" data-placement="bottom"><i class="fal fa-info-circle"></i></button>
                </div>
              </div>
              <div class="form-group mb-0">
                ...
                <div class="row">
                  <div class="col-md-6 mb-0">
                    <a href="#" class="btn btn btn-border">Enquiry</a>
                  </div>
                  <div class="col-md-6 mb-0">
      ...
      <div class="tab-section">
        ...
        <div class="tab-content">
          <div id="Description" class="tab-pane active">
            ...
            <div class="n-text">
              <ul>
                <li>Round trip transportation from the Transportation Hub at the Civitavecchia Cruise pier!</li>
                <li>Air-conditioned, fully licensed and insured transportation!</li>
                <li>English speaking certified driver/guide for groups of 8 or less!</li>
                <li>Driver and separate English speaking certified guide while in Rome for groups of 9-30!</li>
                <li>Round trip transportation from the Transportation Hub at the Civitavecchia Cruise pier!</li>
                <li>Admission into the Colosseum (with availability) or free time at the Colosseum!</li>
                <li>Walking excursion of Old Rome!</li>
                <li>Free time at St. Peters Square in the Vatican City!</li>
                <li>Escape the cruise ship shore excursion crowds and enjoy unique sights of Civitavecchia and surrounding area!</li>
              </ul>
              <p>Your time in Rome is precious so don't waste your day with an overcrowded cruise ship sponsored excursion. Enjoy a more personal, small group excursion that even includes a visit to the Colosseum, not just a view from the outside. See the best Rome has to offer!</p>
              <p>You will take the free shuttle from your Civitavecchia pier to the transportation hub near the harbor's main gate. You will meet your English speaking staff and then board your air-conditioned transportation for the 80-minute journey to Rome. Group size is kept to a maximum of 30 guests to ensure personalized service. On arrival in Rome, take in the view of Capitoline Hill, one of the city's famous 7 hills. Once a Roman citadel, it was the hub of politics and religion.</p>
              <p>Your small group will continue to the Roman Colosseum. Also known as the symbol of the Eternal City, it is famous for being the center of ancient Roman entertainment, gladiators, and wild beasts would challenge each other in front of over 50,000 onlookers. Enjoy 40 minutes of free time and your included admission ticket inside to explore and take photos - please note that admission inside is subject to availability. If admission is unavailable, then there will be a 14 euro refund. You can also see the Arch of Titus by the Colosseum which was built in honor of war victories by an Emperor. An additional cost of 20 euros if guests want to skip the line at the Colosseum and spend more time inside (payable on site) also subject to availability.</p>
              <p>Pass by Palatine Hill, Circus Maximus, and the Victor Emanuel monument before embarking on a guided walking exploration. Stroll through narrow streets to the city's largest Baroque fountain that you may recognize from the 1954 movie, Three Coins in a Fountain. Trevi Fountain, as superstition, states, that if you throw a coin a particular way into the fountain, you have a guaranteed return to Rome. Try your luck! You will also visit the Pantheon, a temple to all Ancient Roman gods. Time permitting, you will also see Navona Square and Farnese Square.</p>
              <p>There is a quick lunch break and your guide will be able to offer suggestions on where to dine and try some of the authentic Italian food. Lunch is at guests expense.</p>
              <p>After lunch, you will visit the Vatican City. En-route, you will pass the Castle of the Angels (Castel Sant' Angelo) and Bernini's Bridge of the Angels. When you arrive at St. Peter's Square, enjoy 45 minutes free time to visit the world's largest church, St. Peter's Basilica, explore the square, soak up the atmosphere or do some souvenir shopping. Please note that due to the popularity of St. Peter's Basilica, waiting times to enter the church may be excessive.</p>
              <p>At the appointed time and spot, you will regroup with your transportation and head back to your ship pier in Civitavecchia, approximately 80 minutes away.</p>
              <p>Please note the sequence of visits may change due to traffic. Anticipate large crowds at all sites with some entrance lines taking over one hour to clear. For groups with less than nine people onboard, transportation will be by smaller vehicle and your guide will also be your driver. For groups of more than nine people, you will meet your official guide on arrival to Rome.</p>
            </div>
          </div>
