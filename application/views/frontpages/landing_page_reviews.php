<section class="section-title review-tour-title">
    <div class="container">
        <h3><?php echo $landing_page_title; ?></h3>
    </div>
</section>
<section class="pt-80 pb-80 review-section">
    <div class="container">
                        ...
                        <div class="text-content">
                            <h3>
                                ...
                                if ($r['tour_id']) {
                                    ...
                                    <a href="<?php echo base_url() . 'page/' . $landing_page_slug . '/reviews/' . $r['slug']; ?>"><?php echo $r['title']; ?></a>
                                <?php } ?>
                            </h3>
                            <?php
                            if ($r['description']) {
                            ...
                            ?>
                                    <p> <?php echo substr(strip_tags($final_desc), 0, 200); ?>&nbsp;
                                        <?php
                                        if ($r['tour_id']) {
                                            if (get_tour_slug_review($r['tour_id'])) { ?>
                                            ...
                                            <strong><a href="<?php echo base_url() . 'page/' . $landing_page_slug . '/reviews/' . $r['slug']; ?>">Read more</a></strong>
                                        <?php } ?>
                                    </p>
                                <?php } else { ?>
        ...
        <hr>
        <div class="text-center review-pagination-btn mt-20">
            <a href="<?php echo base_url() . 'tour-landing-page/' . $this->uri->segment(2); ?>" class="btn btn-blue backtour-btn float-left"><i class="fal fa-long-arrow-left"></i>&nbsp;&nbsp;Back to landing page</a>
