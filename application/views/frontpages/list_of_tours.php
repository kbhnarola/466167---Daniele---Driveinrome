...
<section class="page-title-section single-city">
    <div class="image-wrap">
        <img src="<?= BASE_URL ?>uploads/tour_city/<?= $tour_feature_image ?>"
            onerror="this.src='<?= DEFAULT_IMAGE ?>/banner_default.png';" alt="Tour Banner">
        <!-- <h1><?php //echo $tour_title;?></h1> -->
    </div>
    <div class="breadcrumb">
        <div class="container">
            <p><a href="<?= BASE_URL ?>">Home</a>&nbsp&nbsp/&nbsp&nbsp<a href="javascript:" class="b_crum">
                    <?= $tour_details_type ?>
                </a>&nbsp&nbsp/&nbsp&nbsp<span class="title">
                    <?= $tour_title ?>
                </span></p>
        </div>
    </div>
    ...
    <div class="container">
      ...
      ?>
            <div class="col-md-4">
                ...
                ?>
                        <img src="<?php echo base_url('assets/images/private.png'); ?>"
                            onerror="this.src='<?= DEFAULT_IMAGE ?>/transfers_default.png';" alt="Private">
                        <?php
                  }
                }
                if ($single_tour_detail['tour_type_table_id'] == 7) {
                  if (strpos(strtolower($tour_title), 'livorno') !== false || strpos(strtolower($tour_title), 'civitavecchia') !== false) {
                  ?>
                        <img src="<?php echo base_url('assets/images/small-group.png'); ?>"
                            onerror="this.src='<?= DEFAULT_IMAGE ?>/transfers_default.png';" alt="Small group">
                        <?php
                  }
                }
                ?>
                    ...
                    <div class="image-wrap">
                        ...
                        ?>
                        <a href="<?php echo base_url('tours/' . $single_tour_detail['tour_slug']); ?>"><img
                                class="lazyload" src="<?= DEFAULT_IMAGE ?>/transfers_default.png"
                                data-src="<?= BASE_URL ?>uploads/<?= $single_tour_detail['feature_image'] ?>"
                                onerror="this.src='<?= DEFAULT_IMAGE ?>/transfers_default.png';" alt="Featured"></a>
                    </div>
                    <div class="content-div">
                        <?php
                $tour_type = 'Shore Excursions';
                $tour_type_table_id = $single_tour_detail['tour_type_table_id'];
                if ($tour_type_table_id == 1 || $tour_type_table_id == 7) {
                  $tour_type = 'Shore Excursions';
                  if ($single_tour_detail['is_city_tour'] == 1) {
                ...
                ?>
                        ...
                        <?php
                                                    ...
                                                    ?>
                        <h5>From the Port of
                            <?= $single_tour_detail['tour_category_title'] ?>
                        </h5>
                        <?php
                                                                                                                                } ?>
                        <h6>
                            <?= $single_tour_detail['tour_title'] ?>
                        </h6>
                  ...
                  ?>
                            <div class="p-info-wrap">
                                <div class="left">
                                    <h5 class="code-id"><span>Code : </span><strong>
                                            <?= $single_tour_detail['unique_code'] ?>
                                        </strong></h5>
                                    <h5 class="code-id"><span>Type : </span><strong>
                                            <?= $single_tour_detail['tour_type_title'] ?>
                                        </strong></h5>
                                    <p class="duration"><i class="far fa-clock"></i>Duration :
                                        <?= $single_tour_detail['duration'] ?>
                    ...
                    ?>
                        ...
                        if ($single_tour_detail['tour_type_table_id'] != 8) { ?>
                                    <div class="price-tag">
                                        <img src="<?= ASSET ?>images/euro-price-tag.png"
                                            onerror="this.src='<?= DEFAULT_IMAGE ?>/transfers_default.png';"
                                            alt="Price tag">
                                        Starting From:<br>
                                        <?php
                            ...
                            if ($single_tour_detail['tour_type_table_id'] == 1) {
                                $tour_variations[] = '1-2';
                            } else if ($single_tour_detail['tour_type_table_id'] == 3) {
                                $tour_variations[] = '1-3';
                            } else if ($single_tour_detail['tour_type_table_id'] == 7) {
                                $tour_variations[] = 'Adults';
                            } else if ($single_tour_detail['tour_type_table_id'] == 8) {
                                $tour_variations[] = '1';
                            }
                        ...
                        ?>
                            ...
                            ?>
                                    ...
                                    <?php } ?>
                                    <a href="<?= base_url('tours/' . $single_tour_detail['tour_slug']) ?>"
                                        class="btn btn-blue">Details</a>
                                </div>
                            </div>
                        </div>
                    </div>
