    ...
    */
	...
	public function add()
	{
		if ($this->input->post())
		{
            ...
            $this->form_validation->set_rules('transfer_email_description', 'Transfer email description', 'trim|required');
            ...
            if($this->form_validation->run() == FALSE) {
                ...
                $transfer_email_description=trim($this->input->post("transfer_email_description"));
    	        ...
    	        $data=array(
                    ...
                    "duration"=>$duration,                   
                    "transfer_email_description"=>$transfer_email_description,                   
                    "ratings"=>$ratings,
