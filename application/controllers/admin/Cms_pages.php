    ...
    */
    public function getLists()
    {
        ...
        foreach($memData as $cms){         
            ...
            if($cms->id==12 || $cms->parent_id!=0){
                $data[$j]['page_url'] = base_url().'tour-landing-page/'.$cms->slug;
            } else {
    ...
    */
    ...
    public function get_reviews() {
        if($this->input->post()) {
            ...
            $get_reviewlist=$this->reviews->get_many_by(array('tour_id'=>$tour_id));
            ...
            if($cms_page_id!='' ) {
                ...
                if(is_array($get_page_content) && sizeof($get_page_content)>0) {
                    ...
                    if($insert_id){
                        ...
                        $response['success']=false;
                        $response['msg']="Something1 went wrong!";
                    }      
                } else {
                    $response['success']=false;
                    $response['msg']="Something2 went wrong!";
                }
            } else {
                $response['success']=false;
                $response['msg']="Something3 went wrong!";
            }
            echo json_encode($response);
            exit;
        } else {
