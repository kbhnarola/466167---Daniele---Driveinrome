...

{
    ...
    //         if(in_array($tours->tour_date,$result)) {

    //             // $result_array[$tours->tour_date][$j]['tour_date']=$tours->tour_date;

    //             // $result_array[$tours->tour_date][$j]['variation']=$tours->variation;

    //             // $result_array[$tours->tour_date][$j]['price']=$tours->price;



    //             $result_array[$j]['price'][$tours->variation]=$tours->price;
    ...
    //             $result_array[$j]['tour_date']=$tours->tour_date;
