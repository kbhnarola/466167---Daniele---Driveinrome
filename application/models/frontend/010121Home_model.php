...
class Home_model extends CI_Model{
    ...
    public function get_top_selling_tours(){
        $result_array = array();
        $this->db->select('t.id, t.title as tour_title, t.tour_category_id, t.tour_type_id, t.duration, t.rating, t.feature_image, t.top_selling_tour , t.status, tc.title as tour_category_title,  tt.title as tour_type_title');
