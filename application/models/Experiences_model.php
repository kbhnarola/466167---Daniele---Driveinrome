...
class Experiences_model extends MY_Model
{
	...
	protected $_table = TBL_EXPERIENCES_DETAILS;
	...
	public function __construct()
	{
		...
		$this->table = TBL_EXPERIENCES_DETAILS;

	}

	public function insert_experiences_details($data, $id = null)
{
    ...
    return $inserted ? true : false; // Return true if insert is successful, otherwise false
     ...
     public function get_experiences($postData) {
        // var_dump($postData);die;
        $this->db->select('id,title,description,image,price');
        ...
        foreach ($data as $key => $img) {
            $data[$key]['image'] = base_url('uploads/experiences/images/') . $img['image'];
        }
        // var_dump($data);die;
        return [
            "draw" => $_POST['draw'],
    ...
    public function get_experiences_web() {
