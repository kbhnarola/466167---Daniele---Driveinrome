...

{
...

    {
        ...
        $this->db->select('tour.title,tour.unique_code,tour.id,tour.banner_image,tour.feature_image,tour.tour_type_id,tour.slug as tour_slug,tour.tour_email_description, tour.active_campaign_automation_id, city.title as city,city.slug as city_slug');
...

    {
        ...
        $this->db->select('tour.title,tour.id as tour_id,tour.unique_code,tour.duration,tour.slug as tour_slug,tour.banner_image,tour.feature_image,tour.tour_type_id,tour_type.title as tour_type,tour.extra_services_id, tour.extra_costs_id,city.title as city,city.slug as city_slug');
