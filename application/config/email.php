...
$config = array(
	...
	'smtp_user'    => (get_settings('smtp_user') != null) ? trim(get_settings('smtp_user')) : 'dev.narola2020@gmail.com',
	'smtp_pass'    => (get_settings('smtp_password') != null) ? trim(get_settings('smtp_password')) : 'Dev.narola@2020',
